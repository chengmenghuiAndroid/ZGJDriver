...
package com.lty.zgj.driver.progress.kprogresshud;
...
public class KProgressHUD {
  ...
  /**
   * Create a new HUD. specify the HUD style (if you use a custom com.lty.bus.thailand.view, you need {@code KProgressHUD.create(Context context)}).
   *
   * @param context Activity context that the HUD bound to
   ...
   */
    ...
    /**
     * Specify the HUD style (not needed if you use a custom com.lty.bus.thailand.view)
     * @param style One of the KProgressHUD.Style values
     * @return Current HUD
     */
    public KProgressHUD setStyle(Style style) {
        ...
        switch (style) {
            ...
            case BAR_DETERMINATE:
                ...
                break;
            // No custom com.lty.bus.thailand.view style here, because com.lty.bus.thailand.view will be added later
        }
    ...
    /**
     * Set HUD size. If not the HUD com.lty.bus.thailand.view will use WRAP_CONTENT instead
     * @param width in dp
     * @param height in dp
     * @return Current HUD
     */
     ...
     * com.lty.bus.thailand.view which implements Determinate interface.
     */
    ...
    /**
     * Provide a custom com.lty.bus.thailand.view to be displayed.
    ...
    public KProgressHUD setCustomView(View view) {
        if (view != null) {
            ...
            throw new RuntimeException("Custom com.lty.bus.thailand.view must not be null!");
        }
        return this;
    }
    ...
    public KProgressHUD show(Context context) {
